#pragma config(Motor,  port1,           middleLeftLauncher, tmotorVex393_HBridge, openLoop)
#pragma config(Motor,  port2,           leftTopLauncher, tmotorVex393_MC29, openLoop, reversed)
#pragma config(Motor,  port3,           leftBottomLauncher, tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port5,           rightTopLauncher, tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port6,           rightBottomLauncher, tmotorVex393_MC29, openLoop, reversed)
...
#pragma config(Motor,  port10,          middleRightLauncher, tmotorVex393_HBridge, openLoop, reversed)
...
//#include "IanFlyWheel2.h"
#include "IanAutonomous.h"
//#include "IanIntake.h"
#include "IanFlyWheel3.h"
